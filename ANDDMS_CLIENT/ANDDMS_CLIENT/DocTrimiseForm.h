...
namespace ANDDMSCLIENT {
	...
	/// </summary>
	public ref class DocTrimiseForm : public System::Windows::Forms::Form
	{
	public:
		Pachet^ clientul;
		DocTrimiseForm(Pachet^ c)
		{
			clientul = c;
			InitializeComponent();
			//
	...
	private: System::Windows::Forms::DataGridViewTextBoxColumn^ DESTINATAR;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->DESTINATAR = (gcnew System::Windows::Forms::DataGridViewTextBoxColumn());
			...
			this->panel1->Size = System::Drawing::Size(1084, 532);
			...
			this->dataGridView1->Columns->AddRange(gcnew cli::array< System::Windows::Forms::DataGridViewColumn^  >(5) {
				this->TITLU,
					this->DESTINATAR, this->DATA, this->ORA, this->DESCARCA
			});
			...
			this->dataGridView1->Size = System::Drawing::Size(1084, 532);
			this->dataGridView1->TabIndex = 0;
			this->dataGridView1->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocTrimiseForm::dataGridView1_CellClick);
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocTrimiseForm::dataGridView1_CellContentClick);
			this->dataGridView1->CellDoubleClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocTrimiseForm::dataGridView1_CellDoubleClick);
			// 
			// TITLU
			// 
			...
			// DESTINATAR
			// 
			this->DESTINATAR->HeaderText = L"DESTINATAR";
			this->DESTINATAR->Name = L"DESTINATAR";
			this->DESTINATAR->ReadOnly = true;
			// 
			// DATA
			// 
			...
			this->panel2->Size = System::Drawing::Size(1084, 38);
			...
			this->Name = L"DocTrimiseForm";
			this->ShowInTaskbar = false;
			this->Load += gcnew System::EventHandler(this, &DocTrimiseForm::DocTrimiseForm_Load);
...
#pragma endregion
	private: System::Void DocTrimiseForm_Load(System::Object^ sender, System::EventArgs^ e) {
		for (std::list<CDocument>::iterator i = clientul->c->get_docTrimise()->get_docTr()->begin(); i != clientul->c->get_docTrimise()->get_docTr()->end(); i++)
		{
			String^ ids;
