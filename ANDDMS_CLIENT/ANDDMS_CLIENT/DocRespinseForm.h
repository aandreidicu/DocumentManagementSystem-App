...
namespace ANDDMSCLIENT {
	...
	/// </summary>
	public ref class DocRespinseForm : public System::Windows::Forms::Form
	{
	public:
		Pachet^ clientul;
		DocRespinseForm(Pachet^ c)
		{
			clientul = c;
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->dataGridView1->CellClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocRespinseForm::dataGridView1_CellClick);
			this->dataGridView1->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocRespinseForm::dataGridView1_CellContentClick);
			this->dataGridView1->CellDoubleClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &DocRespinseForm::dataGridView1_CellDoubleClick);
			// 
			// TITLU
			// 
			...
			this->Name = L"DocRespinseForm";
			this->ShowInTaskbar = false;
			this->Load += gcnew System::EventHandler(this, &DocRespinseForm::DocRespinseForm_Load);
			(cli::safe_cast<System::ComponentModel::ISupportInitialize^>(this->dataGridView1))->EndInit();
			this->ResumeLayout(false);

		}
#pragma endregion
	private: System::Void DocRespinseForm_Load(System::Object^ sender, System::EventArgs^ e) {
		for (std::list<CDocument>::iterator i = clientul->c->get_docRespinse()->get_docRe()->begin(); i != clientul->c->get_docRespinse()->get_docRe()->end(); i++)
		{
			String^ ids;
